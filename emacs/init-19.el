...
;; Copyright (C) 1992, 93, 94, 95, 96, 97, 99, 00, 04, 2008 Noah S. Friedman

;; Author: Noah Friedman <friedman@splode.com>
;; Maintainer: friedman@splode.com

;; $Id: init-19.el,v 1.105 2010/02/22 05:17:18 friedman Exp $
...
(defvar default-window-system-frame-font-alist
  '((x . (or (car (x-list-fonts
                   "-*-terminus-medium-r-normal-*-12-*-*-*-c-60-iso8859-1"
                   nil nil 1))
             "fixed"))
